...
(1, 'Aleksandra Marinkovic', 'sanja', 'sanja', 1, '0628586901'),
(2, 'Marija Jaksic', 'maki', 'maki', 1, '0646988258'),
(3, 'Jelena Milinkovic', 'jeca', 'jeca', 1, '065966874'),
(4, 'Petar', 'Petrovic', 'petar', 0, '0623231314'),
...
--
ALTER TABLE `rezervacija`
  MODIFY `rezervacijaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
